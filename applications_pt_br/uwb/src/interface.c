...
//  statusicon = gtk_status_icon_new_from_file("TdspUsbWB.png");
  ...
  gtk_status_icon_set_tooltip(statusicon, _("Bluetooth e WLAN"));
...
void adjust_tooltip_text(gint state)
{
  ...
  case (BLUETOOTH_ENABLE_WLAN_DISABLE):
    gtk_status_icon_set_tooltip(statusicon, _("Bluetooth"));
    break;
  case (BLUETOOTH_DISABLE_WLAN_ENABLE):
    gtk_status_icon_set_tooltip(statusicon, _("WLAN"));
    break;
  ...
  case (BLUETOOTH_WLAN_ERROR):
    gtk_status_icon_set_tooltip(statusicon, _("Erro no 3DSP"));
    break;
  default:
    debug("Estado de Erro\n");
  }
  return;
}
...
GtkWidget *create_menu1(void)
{
  ...
  gtk_tooltips_set_tip(tooltips, bluetooth1, _("Bluetooth"), NULL);
