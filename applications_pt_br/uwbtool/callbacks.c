...
void on_bluetooth_activate()
{
  ...
  debug("+ chamada da funcao: on_bluetooth_active()\n");
  
#ifndef DISABLE_CONFIG_FILE
  
  if (g_allowedmodes[0] == 0)
  {
    printf("O modo: bt(bluetooth) esta desabilitado!\n");
    return;
  }
  ...
  if (!g_iscardin)
  {
    ...
    printf("chamada on_bluetooth_active, retornou the g_iscardin = FALSE\n");
    g_isclickinginprogress = FALSE;
    return;
  }
  if (g_state == BLUETOOTH_ENABLE_WLAN_DISABLE)
  {
    printf("chamada onbluetoothactive, the last state already is on_bluetooth\n");
    g_isclickinginprogress = FALSE;
    return;
  }
      ...
      || g_state == BLUETOOTH_ENABLE_WLAN_ENABLE)
  {
    ...
    {
      printf("falha de dispositivo desconectado ! \n");
      g_isclickinginprogress = FALSE;
      return;
    }
...
void on_wlan_activate()
{
  ...
  debug("+ chamada da funcao: on_wlan_active()\n");
  
#ifndef DISABLE_CONFIG_FILE
  if (g_allowedmodes[1] == 0)
  {
    printf("O modo: wlan esta desabilitado!\n");
    return;
  }
  ...
  if (g_iscardin == FALSE)
  {
    g_state = BLUETOOTH_DISABLE_WLAN_DISABLE;
    g_isclickinginprogress = FALSE;
    printf(" chamada da funcao on_wlan_active, retornou g_iscardin=FALSE\n");
    return;
  }

  if (g_state == BLUETOOTH_DISABLE_WLAN_ENABLE)
  {
    printf("\nMenu WLAN já foi selecionado !\n");
    g_isclickinginprogress = FALSE;
    return;
  }
  usleep(500000);
...
void on_coexist_activate()
{
  ...
  debug("+ chamada funtion: on_coexist_active:\n");
  ...
  if (!g_iscardin)
  {
    g_state = BLUETOOTH_DISABLE_WLAN_DISABLE;
    g_isclickinginprogress = FALSE;
    printf("on_coexist_active, retornou nocardin\n");
    return;
  }
  if (g_state == BLUETOOTH_ENABLE_WLAN_ENABLE)
  {
    g_isclickinginprogress = FALSE;
    printf("on_coexist_active, retornou its current state also is COEXIST\n");
    return;
  }
  ...
  if (g_state == BLUETOOTH_ENABLE_WLAN_DISABLE|| g_state == BLUETOOTH_DISABLE_WLAN_ENABLE)
  {
    ...
    {
      g_isclickinginprogress = FALSE;
      printf("on_coexist_active, retornou unplugdevices fail\n");
      return;
    }
    wait_device_unplug_stable();
  }
  ...
  if (tdsp_is_download_dspcode_ok() == FALSE)
  {
    ...
    adjust_func_state();
    g_isclickinginprogress = FALSE;
    printf("on_coexist_active, retornou download_dspcode fail\n");
    return;
  }
  ...
  while (1)
  {
    ...
    if (g_dsppnpstate != Started)
    {
      ...
      {
        g_isclickinginprogress = FALSE;
        printf("on_coexist_active, retornou power fail\n");
        return;
      }
      usleep(500000);
      continue;
...
void on_coexist_activate()
{
  ...
  debug("+ chamada da funcao: on_coexist_active:\n");
  
#ifndef DISABLE_CONFIG_FILE
  if (g_allowedmodes[2] == 0)
  {
    printf("O modo: combo esta desabilitado!\n");
    return;
  }
#elif DISABLE_COMBO
    printf("the mode: combo is disabled!\n");
  ...
  {
    g_isclickinginprogress = FALSE;
    printf("on_coexist_active, retornou que o estado atual também é COEXIST\n");
    return;
  }
  ...
  if (g_state == BLUETOOTH_ENABLE_WLAN_DISABLE|| g_state == BLUETOOTH_DISABLE_WLAN_ENABLE)
  {
    ...
    {
      g_isclickinginprogress = FALSE;
      printf("on_coexist_active, retornou falha de dispositivo desconectado\n");
      return;
    }
    wait_device_unplug_stable();
  }
  ...
  if (tdsp_is_download_dspcode_ok() == FALSE)
  {
    ...
    adjust_func_state();
    g_isclickinginprogress = FALSE;
    printf("on_coexist_active, retornou falha de download_dspcode\n");
    return;
  }
  ...
  while (1)
  {
    ...
    if (g_dsppnpstate != Started)
    {
      ...
      {
        g_isclickinginprogress = FALSE;
        printf("on_coexist_active, retornou falha de powerOn\n");
        return;
      }
      usleep(500000);
      continue;
...
//      goto first_label;
      ...
      || g_state == BLUETOOTH_ENABLE_WLAN_ENABLE)
  {
    if (FALSE == unplugdevices())
    {
      debug("falha de dispositivo desconectado ! \n");
      g_isclickinginprogress = FALSE;
      return;
    }
    wait_device_unplug_stable();
...
void on_poweron_activate()
{
  ...
  logging("chamando on_poweron_active  ", __LINE__);
...
void on_poweroff_activate()
{
  ...
  debug("chamando on_poweroff_active  ", __LINE__);
